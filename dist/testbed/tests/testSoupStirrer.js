...
TestSoupStirrer.prototype.CreateJoint = function() {
  var prismaticJointDef = new liquidfun.b2PrismaticJointDef();
...
TestSoupStirrer.prototype.Step = function() {
  ...
  var forceVector =
    new liquidfun.b2Vec2(Math.sin(forceAngle), Math.cos(forceAngle));
  liquidfun.b2Vec2.MulScalar(forceVector, forceVector, k_forceMagnitude);
