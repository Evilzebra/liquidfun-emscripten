function TestGears() {
  ...
  // gear 2
  circle1 = new liquidfun.b2CircleShape;
  circle1.radius = 1.0;

  circle2 = new liquidfun.b2CircleShape;
  circle2.radius = 2.0;

  box = new liquidfun.b2PolygonShape;
  box.SetAsBoxXY(0.5, 5.0);

  bd1 = new liquidfun.b2BodyDef;
  bd1.type = liquidfun.b2_dynamicBody;
  bd1.position.Set(-3.0, 12.0);
  body1 = world.CreateBody(bd1);
  body1.CreateFixtureFromShape(circle1, 5.0);

  jd1 = new liquidfun.b2RevoluteJointDef;
  jd1.bodyA = ground;
  jd1.bodyB = body1;
  ...
  jd2 = new liquidfun.b2RevoluteJointDef;
  this.joint2 = jd2.InitializeAndCreate(ground, body2, bd2.position);

  bd3 = new liquidfun.b2BodyDef;
  bd3.type = liquidfun.b2_dynamicBody;
  bd3.position.Set(2.5, 12.0);
  body3 = world.CreateBody(bd3);
  body3.CreateFixtureFromShape(box, 5.0);

  var jd3 = new liquidfun.b2PrismaticJointDef;
  jd3.lowerTranslation = -5.0;
  jd3.upperTranslation = 5.0;
  jd3.enableLimit = true;

  this.joint3 = jd3.InitializeAndCreate(ground, body3, bd3.position, new liquidfun.b2Vec2(0.0, 1.0));

  var jd4 = new liquidfun.b2GearJointDef;
  jd4.bodyA = body1;
  jd4.bodyB = body2;
  ...
  var jd5 = new liquidfun.b2GearJointDef;
  jd5.bodyA = body2;
  jd5.bodyB = body3;
