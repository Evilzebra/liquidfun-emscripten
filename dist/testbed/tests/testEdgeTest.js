function TestEdgeTest() {
  ...
  var v1 = new liquidfun.b2Vec2(-10.0, 0.0);
  var v2 = new liquidfun.b2Vec2(-7.0, -2.0);
  var v3 = new liquidfun.b2Vec2(-4.0, 0.0);
  var v4 = new liquidfun.b2Vec2(0.0, 0.0);
  var v5 = new liquidfun.b2Vec2(4.0, 0.0);
  var v6 = new liquidfun.b2Vec2(7.0, 2.0);
  var v7 = new liquidfun.b2Vec2(10.0, 0.0);
