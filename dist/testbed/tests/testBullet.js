function TestBullet() {
  ...
  edge.Set(new liquidfun.b2Vec2(-10, 0), new liquidfun.b2Vec2(10, 0));
  body.CreateFixtureFromShape(edge, 0);

  var shape = new liquidfun.b2PolygonShape();
  shape.SetAsBoxXYCenterAngle(0.2, 1.0, new liquidfun.b2Vec2(0.5, 1), 0);
  ...
  this.bullet.SetLinearVelocity(new liquidfun.b2Vec2(0, -50));
  this.step = 0;
}
...
TestBullet.prototype.Step = function() {
  Step();
  if (this.step % 60 === 0) {
    this.body.SetTransform(new liquidfun.b2Vec2(0, 4), 0);
    this.body.SetLinearVelocity(new liquidfun.b2Vec2(0, 0));
    this.body.SetAngularVelocity(0);

    var x = RandomFloat(-1.0, 1.0);
    this.bullet.SetTransform(new liquidfun.b2Vec2(x, 10), 0);
    this.bullet.SetLinearVelocity(new liquidfun.b2Vec2(0, -50));
