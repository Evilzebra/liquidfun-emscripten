function TestSliderCrank() {
  ...
  this.joint1 = rjd.InitializeAndCreate(prevBody, body, new liquidfun.b2Vec2(0.0, 5.0));
  ...
  rjd.InitializeAndCreate(prevBody, body, new liquidfun.b2Vec2(0.0, 9.0));
  ...
  rjd = new liquidfun.b2RevoluteJointDef;
  rjd.InitializeAndCreate(prevBody, body, new liquidfun.b2Vec2(0.0, 17.0));
  ...
  this.joint2 =
  pjd.InitializeAndCreate(ground, body, new liquidfun.b2Vec2(0.0, 17.0), new liquidfun.b2Vec2(0.0, 1.0));
