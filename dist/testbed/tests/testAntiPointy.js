function TestAntiPointy() {
  ...
  for (var i = -10; i < 10; i += step) {
    ...
    shape.vertices[0] = new liquidfun.b2Vec2(i, -10);
    shape.vertices[1] = new liquidfun.b2Vec2(i + step, -10),
  ...
  for (var i = -10; i < 35; i += step) {
    var shape = new liquidfun.b2PolygonShape();
    shape.vertices[0] = new liquidfun.b2Vec2(-10, i);
    shape.vertices[1] = new liquidfun.b2Vec2(-10, i + step),
    shape.vertices[2] = new liquidfun.b2Vec2(0, 15);
