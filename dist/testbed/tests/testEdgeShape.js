...
function TestEdgeShape() {
  ...
  for (var i = 0; i < 80; ++i) {
    ...
    shape.Set(new liquidfun.b2Vec2(x1, y1), new liquidfun.b2Vec2(x2, y2));
  ...
  var s1 = new liquidfun.b2PolygonShape;
  s1.vertices.push(new liquidfun.b2Vec2(-0.5, 0.0));
  s1.vertices.push(new liquidfun.b2Vec2(0.5, 0.0));
  s1.vertices.push(new liquidfun.b2Vec2(0.0, 1.5));
  this.polygons.push(s1);

  var s2 = new liquidfun.b2PolygonShape;
  s2.vertices.push(new liquidfun.b2Vec2(-0.1, 0.0));
  s2.vertices.push(new liquidfun.b2Vec2(0.1, 0.0));
  s2.vertices.push(new liquidfun.b2Vec2(0.0, 1.5));
  this.polygons.push(s2);

  var s3 = new liquidfun.b2PolygonShape;
  var w = 1.0;
  var b = w / (2.0 + Math.sqrt(2.0));
  var s = Math.sqrt(2.0) * b;
  s3.vertices.push(new liquidfun.b2Vec2(0.5 * s, 0.0));
  s3.vertices.push(new liquidfun.b2Vec2(0.5 * w, b));
  s3.vertices.push(new liquidfun.b2Vec2(0.5 * w, b + s));
  s3.vertices.push(new liquidfun.b2Vec2(0.5 * s, w));
  s3.vertices.push(new liquidfun.b2Vec2(-0.5 * s, w));
  s3.vertices.push(new liquidfun.b2Vec2(-0.5 * w, b + s));
  s3.vertices.push(new liquidfun.b2Vec2(-0.5 * w, b));
  s3.vertices.push(new liquidfun.b2Vec2(-0.5 * s, 0.0));
  ...
  this.circle = new liquidfun.b2CircleShape;
...
TestEdgeShape.prototype.Step = function() {
  Step();
  var L = 25.0;
  var point1 = new liquidfun.b2Vec2(0.0, 10.0);
  var d = new liquidfun.b2Vec2(L * Math.cos(this.angle), -L * Math.abs(Math.sin(this.angle)));
  var point2 = new liquidfun.b2Vec2();
  liquidfun.b2Vec2.Add(point2, point1, d);
  ...
  if (callback.fixture) {
    ...
    var head = new liquidfun.b2Vec2();
    liquidfun.b2Vec2.MulScalar(head, callback.normal, 0.5);
