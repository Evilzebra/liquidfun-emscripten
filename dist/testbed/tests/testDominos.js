function TestDominos() {
  ...
  shape = new liquidfun.b2PolygonShape;
  shape.SetAsBoxXYCenterAngle(7.0, 0.25, new liquidfun.b2Vec2(), 0.3);
  ...
  anchor.Set(-7.0, 15.0);
  jd.InitializeAndCreate(liquidfun.b2, b4, anchor);
  ...
  fd.density = 10.0;
  fd.friction = 0.1;
  shape.SetAsBoxXYCenterAngle(1.0, 0.1, new liquidfun.b2Vec2(0.0, -0.9), 0.0);
  ...
  fd.density = 10.0;
  fd.friction = 0.1;
  shape.SetAsBoxXYCenterAngle(0.1, 1.0, new liquidfun.b2Vec2(-0.9, 0.0), 0.0);
  b5.CreateFixtureFromDef(fd);
  ...
  var anchor = new liquidfun.b2Vec2();
  anchor.Set(6.0, 2.0);
  ...
  liquidfun.b2Vec2.Sub(d, djd.bodyB.GetWorldPoint(djd.localAnchorB), djd.bodyA.GetWorldPoint(djd.localAnchorA));
  djd.length = d.Length();
