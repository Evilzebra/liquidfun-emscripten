function TestCornerCase() {
  ...
  shape.vertices.push(new liquidfun.b2Vec2(-20.0, 30.0));
  shape.vertices.push(new liquidfun.b2Vec2(-20.0, 0.0));
  shape.vertices.push(new liquidfun.b2Vec2(-25.0, 0.0));
  shape.vertices.push(new liquidfun.b2Vec2(-25.0, 30.));
  ...
  shape = new liquidfun.b2PolygonShape;
  shape.vertices.push(new liquidfun.b2Vec2(-25.0, 0.0));
  shape.vertices.push(new liquidfun.b2Vec2(20.0, 15.0));
  shape.vertices.push(new liquidfun.b2Vec2(25.0, 0.0));
  ...
  for (x = -xrange; x < xrange; x += xstep) {
    shape = new liquidfun.b2PolygonShape;
    shape.vertices.push(new liquidfun.b2Vec2(-25.0, 0.0));
    shape.vertices.push(new liquidfun.b2Vec2(x, 15.0));
    shape.vertices.push(new liquidfun.b2Vec2(x + xstep, 15.0));
    ground.CreateFixtureFromShape(shape, 0.0);
  }

  for (y = 0.0; y < yrange; y += ystep) {
    shape = new liquidfun.b2PolygonShape;
    shape.vertices.push(new liquidfun.b2Vec2(25.0, y));
    shape.vertices.push(new liquidfun.b2Vec2(25.0, y+ystep));
    shape.vertices.push(new liquidfun.b2Vec2(20.0, 15.0));
