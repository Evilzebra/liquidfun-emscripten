function TestPulley() {
  ...
  edge.Set(new liquidfun.b2Vec2(-40.0, 0.0), new liquidfun.b2Vec2(40.0, 0.0));
  ...
  var pulleyDef = new liquidfun.b2PulleyJointDef;
  var anchor1 = new liquidfun.b2Vec2(-10.0, y + b);
  var anchor2 = new liquidfun.b2Vec2(10.0, y + b);
  var groundAnchor1 = new liquidfun.b2Vec2(-10.0, y + b + L);
  var groundAnchor2 = new liquidfun.b2Vec2(10.0, y + b + L);
  this.joint1 =
