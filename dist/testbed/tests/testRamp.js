function TestRamp() {
  ...
  for (var y = 30; y > 0; y -= ystep) {
    ...
    shape.vertices[0] = new liquidfun.b2Vec2(-25, y);
    shape.vertices[1] = new liquidfun.b2Vec2(-25, y - ystep),
    shape.vertices[2] = new liquidfun.b2Vec2(0, 15);
  ...
  for (var x = -25; x < 25; x += xstep) {
    var shape = new liquidfun.b2PolygonShape();
    shape.vertices[0] = new liquidfun.b2Vec2(x, 0);
    shape.vertices[1] = new liquidfun.b2Vec2(x + xstep, 0),
    shape.vertices[2] = new liquidfun.b2Vec2(0, 15);
  ...
  pd.flags = liquidfun.b2_waterParticle;
  pd.shape = circle;
